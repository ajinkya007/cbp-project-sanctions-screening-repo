...
public class Transaction implements Serializable {
	...
	public String toString() {
		return "Transaction [refNumber=" + refNumber + ", date=" + date + ", payerName=" + payerName + ", payerAccount="
				+ payerAccount + ", payeeName=" + payeeName + ", payeeAccount=" + payeeAccount + ", amount=" + amount
